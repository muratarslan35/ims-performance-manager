...
def test_region_uses_official_target_minus_balance_when_weekly_actual_missing(app):
...
def test_representative_period_prefers_persisted_ims_actual_over_corrupt_summary(app):
    from app.extensions import db
...
def test_representative_period_preserves_legacy_summary_when_target_actual_unset(app):
    from app.extensions import db
    from app.models import IMSSummary, IMSUpload, Product, Representative, Target
    from app.services.representative_period_snapshot_service import RepresentativePeriodSnapshotService
...
def test_annual_realization_prefers_persisted_target_actual(app):
    from app.extensions import db
    from app.models import IMSSummary, IMSUpload, Product, Representative, Target
