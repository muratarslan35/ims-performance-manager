...
class IMSUpload(db.Model):
    ...
    source_record_count = db.Column(db.Integer, default=0, nullable=False)
    stored_source_record_count = db.Column(db.Integer, default=0, nullable=False)
    zero_metric_count = db.Column(db.Integer, default=0, nullable=False)
    blank_metric_count = db.Column(db.Integer, default=0, nullable=False)
    invalid_metric_count = db.Column(db.Integer, default=0, nullable=False)
    excluded_aggregate_count = db.Column(db.Integer, default=0, nullable=False)
    reconciliation_status = db.Column(db.String(30), default="NOT_AVAILABLE", nullable=False)
...
class ProductionResult(db.Model):
    ...
    unit_realization_percent = db.Column(db.Float, nullable=True)
    target_tl = db.Column(db.Float, nullable=True)
    target_unit = db.Column(db.Float, nullable=True)
    actual_tl = db.Column(db.Float, nullable=True)
    actual_unit = db.Column(db.Float, nullable=True)
