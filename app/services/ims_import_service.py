...
from app.services.ims_fact_builder import IMSFactBuilderService
...
class IMSImportService:
    ...
    def create_upload(
        ...
        print(f"RAW RECORDS: {self.statistics['raw_records']}")
        print(f"ROWS: {self.statistics['processed_rows']}")
    ...
    def rebuild_summary(
        ...
        records = (
            ...
            .join(
                ...
                IMSFact.upload_id == IMSUpload.id
    ...
    def clear_month(
        ...
        upload_ids = [
            ...
            for row in IMSUpload.query.filter_by(
        ...
        if upload_ids:
            ...
            IMSRawData.query.filter(
                ...
                IMSRawData.upload_id.in_(upload_ids)
